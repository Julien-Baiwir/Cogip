        ...
        <div class="content pb-5 bg-gray-200 flex-grow w-screen ">
            ...
            <div class=" w-full flex flex-col items-center  h-screen lg:mt-96">
                <div class="bg-white ml-4 mb-4 p-8 rounded-lg shadow-lg  w-10/12 lg:ml-4">
                    <h2 class=" text-lg font-bold text-center mb-2 lg:text-2xl">New contact</h2>
                    <form id="form">
                        <div class="mb-2">
                            <input type="name" id="name" class="text-xs form-input w-full px-4 py-2 border rounded-lg text-gray-700 focus:ring-blue-500 lg:text-base" minlength="3" maxlength="20" required placeholder="Name">
                        </div>
                        <div class="mb-2">
                            <input type="phone" id="tva" class="text-xs form-input w-full px-4 py-2 border rounded-lg text-gray-700 focus:ring-blue-500 lg:text-base" required minlength="3" maxlength="20" placeholder="Phone">
                        </div>
                        <div class="mb-3">
                            <input type="email" id="country" class=" text-xs form-input w-full px-4 py-2 border rounded-lg text-gray-700 focus:ring-blue-500 lg:text-base" required minlength="3" maxlength="20" placeholder="Email">
                        </div>
                    ...
                    <div class="fond bg-white p-8 rounded-lg   w-10/12 ml-8 ">
                        ...
                        <table class="border-0 ml-5 text-xs w-full">
                            <tr>
                                ...
                                <td class="lg:py-1 font-bold lg:text-lg w-[200px]">Phone</th>
                                <td class="lg:py-1  font-bold lg:text-lg">Email</th>
                            </tr>
                            <?php foreach ($fivecontacts as $contact) : ?>
                                <tr>
                                    <td class="lg:py-1 lg:text-base "><?= $contact->getName() ?> </td>
                                    <td class="lg:py-1 lg:text-base"><?= $contact->getPhone() ?></td>
                                    <td class="lg:py-1 lg:text-base pr-4" style="word-wrap: break-word;"><?= $contact->getEmail() ?></td>
