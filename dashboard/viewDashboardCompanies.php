...
<body class="overflow-x-hidden">
    <main class="bg-gray-200  w-screen flex lg:pr-10 ">
        ...
        <div class="content pb-5 bg-gray-200 flex-grow w-screen h-full ">
            ...
            <div class=" w-full flex flex-col lg:items-center  h-screen lg:mt-96">
                <div class="bg-white ml-4 mb-4 p-8 rounded-lg shadow-lg  w-10/12 lg:ml-4">
                    <h2 class=" text-lg font-bold text-center mb-2 lg:text-2xl">New company</h2>
                    <form id="form">
                        <div class="mb-2">
                            <input type="text" id="name" class="text-xs form-input w-full px-4 py-2 border rounded-lg text-gray-700 focus:ring-blue-500 lg:text-base" minlength="3" maxlength="20" required placeholder="Name">
                        </div>
                        <div class="mb-2">
                            <input type="number" id="tva" class="text-xs form-input w-full px-4 py-2 border rounded-lg text-gray-700 focus:ring-blue-500 lg:text-base" required minlength="3" maxlength="20" placeholder="TVA">
                        </div>
                        <div class="mb-3">
                            <input type="text" id="country" class=" text-xs form-input w-full px-4 py-2 border rounded-lg text-gray-700 focus:ring-blue-500 lg:text-base" required minlength="3" maxlength="20" placeholder="Country">
                        </div>
                ...
                <div class="w-full  lg:flex lg:flex-col lg:items-center  lg:mt-8">
                    <div class="fond bg-white p-8 rounded-lg   w-10/12 ml-4 ">
                        ...
                        <table class="border-0 ml-5 text-xs w-full">
                            ...
                            <?php foreach ($fiveCompanies as $fivecomp) : ?>
                                <tr>
                                    ...
                                    <td class="lg:py-1 lg:text-base pr-4 flex " ><a href="#"><img src="src/img/poubelle.svg" class="w-4 m-2"></a><a href="#"><img src="src/img/modify.svg" class="w-4 m-2"></a></td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
                    </div>
